...
class BasePlugin(object):
    ...
    def get_token_secret_form(self):
        # type: () -> Tuple[Type[grouper.secret.Secret], str]
        """Determines which Secret type to use for autogenerated tokens.

        Returns:
            A tuple containing the class of the secret to use for autogenerated tokens, and which
            attribute of that class the value of the token should be stored in.
        """
        return None, ""

    def get_ssh_key_secret_form(self):
        # type: () -> Tuple[Type[grouper.secret.Secret], str]
        """Determines which Secret type to use for autogenerated SSH keys.

        Returns:
            A tuple containing the class of the secret to use for autogenerated ssh keys, and which
            attribute of that class the value of the token should be stored in.
        """
        return None, ""
