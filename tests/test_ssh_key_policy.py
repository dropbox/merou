...
def test_accepts_strong_rsa_keys(get_plugins, session, users):
    get_plugins.return_value = [SshKeyPolicyPlugin()]
...
@patch("grouper.public_key.get_plugins")
def test_rejects_weak_rsa_keys(get_plugins, session, users):
    get_plugins.return_value = [SshKeyPolicyPlugin()]
...
@patch("grouper.public_key.get_plugins")
def test_rejects_dsa_keys(get_plugins, session, users):
    get_plugins.return_value = [SshKeyPolicyPlugin()]
...
@patch("grouper.public_key.get_plugins")
def test_rejects_ecdsa_keys(get_plugins, session, users):
    get_plugins.return_value = [SshKeyPolicyPlugin()]
